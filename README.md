...
Advantages :
 ...
 1. Virtual Machine 
       ...
       * Billing includes the license for windows server (We can mention and cut down the lincense cost if we have the license). This is called as **Azure Hybrid Benefit Pricing
